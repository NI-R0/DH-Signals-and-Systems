...
% \input{inputs/3_Explizite Darstellung des Übertragungsoperators.tex}

\section{Zustandsraumbeschreibung (implizite Systembeschreibung)}
\input{inputs/4_Zustandsraumbeschreibung.tex}

\section{Ein-/Ausgangsdifferentialgleichung}
\input{inputs/5_Ein-Ausgangsdifferentialgleichung.tex}
